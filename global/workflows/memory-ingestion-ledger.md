...
| Context-preserving fleet v2 | reprocessed, review pending | A field/span-preserving sanitizer retained safe sibling context, HAPI messages, nested lesson text, and non-secret SHA provenance while removing dangerous spans. Across 4,384 source files it saw 366,256 records, wrote 362,522, skipped 3,733, and had 1 empty record. Strict scans passed on all seven machine corpora; seven fresh machine-scoped reviews are pending. NFS duplicate views remain one representative. |
