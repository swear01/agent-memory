...
confidence: high
evidence: >-
  完成台大碩一錯誤更正碼第二週、第三週週五題（第 1～11 題）與第三週週一題（第 12～16 題）推導與 XeLaTeX 排版；
...
8. **作業寫作定位：純答題、得分導向（「你是在寫作業，不是寫論文」）**：
   ...
   * 精準控制頁數預算（如 11 題濃縮至剛好 2 頁，或 5 題緊湊排入剛好 1 頁），每題獨立完整，避免跨頁斷頭或孤兒頁。若次頁僅剩十餘行，應透過行內簡短算式與版面微調（如 16mm/13mm 邊界、linespread 1.04）收斂為完美單頁。
