...
- 截至 2026-09-04，Oracle 對 public TCP 22 得到 `Connection refused`，未進入 Windows SSH handshake。外網仍未打通；下一步應確認 DMZ target 是否等於內層 WAN IP，並檢查內層 TCP forwarding，不在記憶中保存實際位址。
